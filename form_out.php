...
<h3>CHECK - OUT</h3>
<a href="?link=ap.php" class="w3-bar-item w3-button w3-right" style="margin-top:-49px; margin-right:15px"><i class="fa fa-times" aria-hidden="true"></i></a>
<br>
</header>
...
echo '<th colspan="4">
	...
	<form action="?link=cad_checkout.php" method="post" class="w3-center">
	<p>
