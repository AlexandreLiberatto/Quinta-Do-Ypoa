...
<div class="w3-container w3-display-middle" style="margin-top:px; width:950px">
<div class="w3-card-4 w3-white">
<header class="w3-light-grey w3-center">

<h3>CADASTRO DE CHECK-IN</h3>
...
<form action="?link=cad_checkin.php" method="post">
<div class="w3-container w3-border w3-round-large">
<p>
<label> CPF </label>
<input name="cpf" class="w3-input w3-border w3-round-large" type="text"  id="cpf" value="<?php echo $cpf; ?>" size="11" maxlength="11"  onblur="pesquisacpf(this.value);" style="width:138px;"/>
...
<input name="nome" id="nome" type="text" class="w3-input w3-border w3-round-large" />
</p>
</div>
</div>
<div class="w3-third">
...
<p>
<label> Fone </label>
<input name="fone" id="fone" type="text" class="w3-input w3-border w3-round-large"  maxlength="11"  />
</p>
</div>
</div>
...
<p>
<label>CEP </label>
<input name="cep" id="cep" type="text" class="w3-input w3-border w3-round-large"  onblur="pesquisacep(this.value);" value="" maxlength="8"  />
</p>
</div>
</div>
...
<input name="rua" id="rua" type="text" class="w3-input w3-border w3-round-large"  size="60"/>
</p>
</div>
</div>
...
<p>
<label> Cidade </label>
<input name="cidade" id="cidade" type="text" class="w3-input w3-border w3-round-large"  />
</p>
</div>
</div>
<div class="w3-third">
...
<p>
<label> Estado </label>
<input  name="uf" id="uf"  type="text" class="w3-input w3-border w3-round-large w3-center"  size="2" maxlength="2"  style="width:70px" />
</p>
</div>
</div>
<div class="w3-third">
...
<textarea name="acompanhantes" id="acompanhantes" class="w3-input w3-border w3-round-large"   cols="30" rows="7"></textarea>
</p>
</div>
</div>
<div class="w3-third">
...
<br>
 <button class="w3-button w3-border w3-round-large"><i class="fa fa-sign-in" aria-hidden="true"></i> Cadastrar entrada</button>
 <br><br />
</footer>
    </form>
    </div>
