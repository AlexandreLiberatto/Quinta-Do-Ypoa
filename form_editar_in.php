...
<form action="?link=editar.php" method="post">
...
<textarea name="acompanhantes" id="acompanhantes" class="w3-input w3-border w3-round-large"   cols="30" rows="7">'.$user['acompanhantes'].'</textarea>
</p>
</div>
</div>
<div class="w3-third">
